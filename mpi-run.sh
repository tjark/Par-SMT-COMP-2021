...
wait_for_nodes () {
  ...
  time mpirun --mca btl_tcp_if_include eth0 --allow-run-as-root -np ${AWS_BATCH_JOB_NUM_NODES} --hostfile combined_hostfile -wdir Par-SMT-COMP-2021/bin/ ./starexec_run_default ../../test.smt2
}
